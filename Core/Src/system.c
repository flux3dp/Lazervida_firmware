...
void system_init()
{
  // TODO: Initialize control pins (not used in FLUX's budget laser)
  /*
...
/* TODO: control pins EXTI IRQ handler (not used in FLUX's budget laser)
...
// NOTE: FLUX's dedicated door/bottom detect DOESN'T use this API
