...
extern GPIO_PIN_TYPE STEP_PIN[N_AXIS];
extern GPIO_BIT_TYPE STEP_BIT[N_AXIS]; 
extern GPIO_PIN_TYPE DIRECTION_MASK;
extern GPIO_PIN_TYPE DIRECTION_PIN[N_AXIS];
extern GPIO_BIT_TYPE DIRECTION_BIT[N_AXIS]; 
extern GPIO_PIN_TYPE LIMIT_MASK;
extern GPIO_PIN_TYPE LIMIT_PIN[N_AXIS];
extern GPIO_BIT_TYPE LIMIT_BIT[N_AXIS]; 

extern GPIO_BIT_TYPE STEPPERS_DISABLE_BIT;
extern GPIO_PIN_TYPE STEPPERS_DISABLE_PIN;

extern GPIO_BIT_TYPE SPINDLE_ENABLE_BIT;
extern GPIO_PIN_TYPE SPINDLE_ENABLE_PIN;

extern void get_rcc_clock_config();
extern void step_pin_mask_init();
extern void dir_pin_mask_init();
extern void limit_pin_mask_init();
extern void stepper_disable_mask_init();
extern void laser_enable_mask_init();
...
#define SPINDLE_PWM_RANGE         (SPINDLE_PWM_MAX_VALUE-SPINDLE_PWM_MIN_VALUE)
  ...
  //#define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
      ...
      #define SPINDLE_DIRECTION_PORT  mock_spindle_direction_port
